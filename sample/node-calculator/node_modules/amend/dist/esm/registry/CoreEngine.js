 ...
 */
export function encode(filePath, line, className, funcName, message, errorClass) {
...
export function errorClassFrom(key) {
    if (!key.startsWith('amend:'))
        return 'ERR';
